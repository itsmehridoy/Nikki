...
@Nikki.on_message(command("blacklist") & filters.group)
...
@Nikki.on_message(command("addblacklist") & restrict_filter)
...
async def rm_allblacklist(_, m: Message):
    ...
    await m.reply_text(
        ...
        reply_markup=ikb(
            [[("Confirm", "rm_allblacklist"), ("❌ Cancel", "close_admin")]],
        ),
    )
    return


@Nikki.on_callback_query(filters.regex("^rm_allblacklist$"))
...
__HELP__ = """
**Dᴇsᴄʀɪᴘᴛɪᴏɴ :**
ᴡᴀɴᴛ ᴛᴏ sᴛᴏᴘ ᴘᴇᴏᴘʟᴇ ᴀsᴋɪɴɢ sᴛᴜᴘɪᴅ ǫᴜᴇsᴛɪᴏɴs? ᴏʀ ʙᴀɴ ᴀɴʏᴏɴᴇ sᴀʏɪɴɢ ᴄᴇɴsᴏʀᴇᴅ ᴡᴏʀᴅs? ʙʟᴀᴄᴋʟɪsᴛs ɪs ᴛʜᴇ ᴍᴏᴅᴜʟᴇ ғᴏʀ ʏᴏᴜ!
...
๏ /blaction ᴀᴄᴛɪᴏɴ: ᴛʜɪs ᴀᴄᴛɪᴏɴ ᴡɪʟʟ ᴏᴄᴄᴜʀ ᴡʜᴇɴ ᴜsᴇʀ uses ᴀ ʙʟᴀᴄᴋʟɪsᴛ ᴡᴏʀᴅ. ᴄʜᴏᴏsᴇ ғʀᴏᴍ - ᴋɪᴄᴋ, ʙᴀɴ, ᴍᴜᴛᴇ, ᴡᴀʀɴ.
