...
@Nikki.on_message(command("disable") & can_change_filter)
...
@Nikki.on_message(command("disabledel") & can_change_filter)
...
@Nikki.on_message(command("enable") & can_change_filter)
...
@Nikki.on_message(command("disableable") & can_change_filter)
...
@Nikki.on_message(command("disabled") & admin_filter)
...
@Nikki.on_message(command("enableall") & owner_filter)
...
@Nikki.on_callback_query(filters.regex("^enableallcmds$"))
