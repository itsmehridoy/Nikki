...
__HELP__ = """
**Dᴇsᴄʀɪᴘᴛɪᴏɴ :**
ᴋᴇᴇᴘ ʏᴏᴜʀ ᴍᴇᴍʙᴇʀs ɪɴ ᴄʜᴇᴄᴋ ᴡɪᴛʜ ᴡᴀʀɴɪɴɢs; sᴛᴏᴘ ᴛʜᴇᴍ ɢᴇᴛᴛɪɴɢ ᴏᴜᴛ ᴏғ ᴄᴏɴᴛʀᴏʟ!

ɪғ ʏᴏᴜ'ʀᴇ ʟᴏᴏᴋɪɴɢ ғᴏʀ ᴀᴜᴛᴏᴍᴀᴛᴇᴅ ᴡᴀʀɴɪɴɢs, ɢᴏ ʀᴇᴀᴅ ᴀʙᴏᴜᴛ ᴛʜᴇ ʙʟᴀᴄᴋʟɪsᴛ ᴍᴏᴅᴜʟᴇ.
────────────────────────
...
๏ /dwarn ʀᴇᴀsᴏɴ: ᴡᴀʀɴ ᴀ ᴜsᴇʀ ʙʏ ʀᴇᴘʟʏ, ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ᴛʜᴇɪʀ message.
๏ /swarn ʀᴇᴀsᴏɴ: ᴡᴀʀɴ ᴡᴀʀɴ ᴀ ᴜsᴇʀ, ᴀɴᴅ ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴍᴇssᴀɢᴇ.
๏ /rmwarn: ʀᴇᴍᴏᴠᴇ ᴀ ᴜsᴇʀ ʟᴀᴛᴇsᴛ ʟᴀᴛᴇs.
๏ /resetwarn: ʀᴇsᴇᴛ ᴀʟʟ ᴏғ a user's ᴡᴀʀɴɪɴɢs ᴛᴏ 𝟶.
๏ /warnings: ɢᴇᴛ ᴛʜᴇ ᴄʜᴀᴛ's ᴡᴀʀɴɪɴɢ sᴇᴛᴛɪɴɢs.
๏ /warnmode ban/kick/mute: sᴇᴛ ᴛʜᴇ ᴄʜᴀᴛ's ᴡᴀʀɴ ᴍᴏᴅᴇ.
๏ /warnlimit ɴᴜᴍʙᴇʀ: sᴇᴛ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴏғ ᴡᴀʀɴɪɴɢs ʙᴇғᴏʀᴇ ᴜsᴇʀs ᴀʀᴇ ᴘᴜɴɪsʜᴇᴅ."""
