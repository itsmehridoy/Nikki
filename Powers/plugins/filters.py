...
async def send_filter_reply(c: Nikki, m: Message, trigger: str):
...
__buttons__ = [
    [
        ("Exᴀᴍᴘʟᴇ", "format.ex_filters"),
        ("Fᴏʀᴍᴀᴛᴛɪɴɢ", "formatting.md_formatting")],
]

__HELP__ = """
**Dᴇsᴄʀɪᴘᴛɪᴏɴ :**
ᴍᴀᴋᴇ ʏᴏᴜʀ ᴄʜᴀᴛ ᴍᴏʀᴇ ʟɪᴠᴇʟʏ ᴡɪᴛʜ ғɪʟᴛᴇʀs; ᴛʜᴇ ʙᴏᴛ ᴡɪʟʟ ʀᴇᴘʟʏ ᴛᴏ ᴄᴇʀᴛᴀɪɴ ᴡᴏʀᴅs!
ғɪʟᴛᴇʀs ᴀʀᴇ ᴄᴀsᴇ ɪɴsᴇɴsɪᴛɪᴠᴇ; ᴇᴠᴇʀʏ ᴛɪᴍᴇ sᴏᴍᴇᴏɴᴇ sᴀʏs ʏᴏᴜʀ ᴛʀɪɢɢᴇʀ ᴡᴏʀᴅs, ᴛʜᴇ ʙᴏᴛ ᴡɪʟʟ ʀᴇᴘʟʏ sᴏᴍᴇᴛʜɪɴɢ ᴇʟsᴇ! ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴛᴏ ᴄʀᴇᴀᴛᴇ ʏᴏᴜʀ ᴏᴡɴ ᴄᴏᴍᴍᴀɴᴅs, ɪғ ᴅᴇsɪʀᴇᴅ.
────────────────────────
**Cᴏᴍᴍᴀɴᴅs :**
๏ /filters : ʟɪsᴛ ᴀʟʟ ᴄʜᴀᴛ ғɪʟᴛᴇʀs.
**Tʜᴇ Fᴏʟʟᴏᴡɪɴɢ Cᴏᴍᴍᴀɴᴅs Aʀᴇ Aᴅᴍɪɴ Oɴʟʏ :**
๏ /filter ᴛʀɪɢɢᴇʀ ʀᴇᴘʟʏ: ᴇᴠᴇʀʏ ᴛɪᴍᴇ sᴏᴍᴇᴏɴᴇ sᴀʏs "ᴛʀɪɢɢᴇʀ", ᴛʜᴇ ʙᴏᴛ ᴡɪʟʟ ʀᴇᴘʟʏ ᴡɪᴛʜ "sᴇɴᴛᴇɴᴄᴇ". ғᴏʀ ᴍᴜʟᴛɪᴘʟᴇ ᴡᴏʀᴅ ғɪʟᴛᴇʀs, ǫᴜᴏᴛᴇ ᴛʜᴇ ᴛʀɪɢɢᴇʀ.
๏ /stop ᴛʀɪɢɢᴇʀ: sᴛᴏᴘ ᴛʜᴇ ʙᴏᴛ ғʀᴏᴍ ʀᴇᴘʟʏɪɴɢ ᴛᴏ "ᴛʀɪɢɢᴇʀ".
๏ /stopall: sᴛᴏᴘ ᴀʟʟ ғɪʟᴛᴇʀs ɪɴ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʜᴀᴛ. ᴛʜɪs ᴄᴀɴɴᴏᴛ ʙᴇ ᴜɴᴅᴏɴᴇ.
**Cʜᴀᴛ ᴄʀᴇᴀᴛᴏʀ ᴏɴʟʏ :**
๏ /stopall: ʀᴇᴍᴏᴠᴇ ᴀʟʟ ᴄʜᴀᴛ ғɪʟᴛᴇʀs ᴀᴛ ᴏɴᴄᴇ."""
