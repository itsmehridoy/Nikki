...
async def get_note_func(c: Nikki, m: Message, note_name, priv_notes_status):
            ...
            reply_markup=ikb(
                [
                    [
                        (
                            "Click Me!",
                            f"https://t.me/{Nikki.username}?start=note_{m.chat.id}_{note_hash}",
                            "url",
                        ),
                    ],
                ],
...
async def get_raw_note(c: Nikki, m: Message, note: str):
...
__alt_name__ = ["groupnotes", "privatenotes", "pmnotes", "snips", "notes"]

__buttons__ = [
    [
        ("Exᴀᴍᴘʟᴇ", "format.notes_content"),
        ("Fᴏʀᴍᴀᴛᴛɪɴɢ", "formatting.md_formatting")],
]

__HELP__ = """
**Dᴇsᴄʀɪᴘᴛɪᴏɴ :**
sᴀᴠᴇ ᴅᴀᴛᴀ ғᴏʀ ғᴜᴛᴜʀᴇ ᴜsᴇʀs ᴡɪᴛʜ ɴᴏᴛᴇs!

ɴᴏᴛᴇs ᴀʀᴇ ɢʀᴇᴀᴛ ᴛᴏ sᴀᴠᴇ ʀᴀɴᴅᴏᴍ ᴛɪᴅʙɪᴛs ᴏғ ɪɴғᴏʀᴍᴀᴛɪᴏɴ; ᴀ ᴘʜᴏɴᴇ ɴᴜᴍʙᴇʀ, ᴀ ɴɪᴄᴇ ɢɪғ, ᴀ ғᴜɴɴʏ ᴘɪᴄᴛᴜʀᴇ - ᴀɴʏᴛʜɪɴɢ!
────────────────────────

**Cᴏᴍᴍᴀɴᴅs :**
๏ /get ɴᴏᴛᴇɴᴀᴍᴇ: ɢᴇᴛ ᴀ ɴᴏᴛᴇ.
• #notename: sᴀᴍᴇ ᴀs /get

**Tʜᴇ Fᴏʟʟᴏᴡɪɴɢ Cᴏᴍᴍᴀɴᴅs Aʀᴇ Aᴅᴍɪɴ Oɴʟʏ :**
๏ /save ɴᴏᴛᴇɴᴀᴍᴇ ɴᴏᴛᴇ-ᴛᴇxᴛ: sᴀᴠᴇ ᴀ ɴᴇᴡ ɴᴏᴛᴇ ᴄᴀʟʟᴇᴅ "ᴡᴏʀᴅ". ʀᴇᴘʟʏɪɴɢ ᴛᴏ ᴀ ᴍᴇssᴀɢᴇ ᴡɪʟʟ sᴀᴠᴇ ᴛʜᴀᴛ ᴍᴇssᴀɢᴇ. ᴇᴠᴇɴ ᴡᴏʀᴋs ᴏɴ ᴍᴇᴅɪᴀ.
๏ /clear ɴᴏᴛᴇɴᴀᴍᴇ: ᴅᴇʟᴇᴛᴇ ᴛʜᴇ ᴀssᴏᴄɪᴀᴛᴇᴅ ɴᴏᴛᴇ.
๏ /notes: ʟɪsᴛ ᴀʟʟ ɴᴏᴛᴇs ɪɴ ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴄʜᴀᴛ.
๏ /saved: sᴀᴍᴇ ᴀs /notes.
๏ /privatenotes: ᴡʜᴇᴛʜᴇʀ ᴏʀ ɴᴏᴛ ᴛᴏ sᴇɴᴅ ɴᴏᴛᴇs ɪɴ PM. ᴡɪʟʟ sᴇɴᴅ ᴀ ᴍᴇssᴀɢᴇ ᴡɪᴛʜ ᴀ ʙᴜᴛᴛᴏɴ ᴡʜɪᴄʜ ᴜsᴇʀs ᴄᴀɴ ᴄʟɪᴄᴋ ᴛᴏ ɢᴇᴛ ᴛʜᴇ ɴᴏᴛᴇ ɪɴ PM.

**Cʜᴀᴛ ᴄʀᴇᴀᴛᴏʀ ᴏɴʟʏ :**
๏ /clearall: ᴅᴇʟᴇᴛᴇ ᴀʟʟ ɴᴏᴛᴇs ɪɴ ᴀ ᴄʜᴀᴛ. ᴛʜɪs ᴄᴀɴɴᴏᴛ ʙᴇ ᴜɴᴅᴏɴᴇ."""
