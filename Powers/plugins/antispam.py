...
@Nikki.on_message(filters.command("gban") & SUDOERS)
async def gban(c: Nikki, m: Message):
...
@Nikki.on_message(filters.command("gunban") & SUDOERS)
async def ungban(c: Nikki, m: Message):
    if len(m.text.split()) == 1:
...
@Nikki.on_message(filters.command("gbancount") & SUDOERS)
...
@Nikki.on_message(filters.command("gbanlist") & SUDOERS)
